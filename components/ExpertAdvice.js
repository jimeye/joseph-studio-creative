      ...
      <div className="fluid-container">
        ...
        <div className="text-center w-full mt-12">
          <div className="border-2 border-b-2 w-full p-8" style={{ backgroundColor: '#d92f35', boxShadow: '4px 4px 0px #16214a', borderColor: '#16214a', borderBottomWidth: '2px', borderBottomColor: '#16214a' }}>
            <h2 className="text-4xl md:text-5xl font-normal mb-2 tracking-tight hero-title text-gray-50" style={{ wordSpacing: '-0.1em', letterSpacing: '-0.05em' }}>
              Votre site web évolue?
            </h2>
            <div className="text-6xl font-bold mb-4" style={{ color: '#16214a' }}>On vous accompagne.</div>
            <p className="text-xl font-semibold mb-4 font-bold text-gray-50">
            ...
            <div className="text-center">
              <div 
                ...
                style={{
                  background: 'linear-gradient(45deg, #f9f7f2 0%, #f9f7f2 100%)',
                  borderRadius: '20px',
                  padding: '8px 32px',
                  boxShadow: '4px 4px 0px #16214a',
                ...
                onMouseEnter={(e) => {
                  e.target.style.background = 'linear-gradient(45deg, #16214a 0%, #16214a 100%)';
                  e.target.style.color = '#f9f7f2';
                  e.target.style.borderColor = '#f9f7f2';
                }}
                onMouseLeave={(e) => {
                  e.target.style.background = 'linear-gradient(45deg, #f9f7f2 0%, #f9f7f2 100%)';
                  e.target.style.color = '#16214a';
                  e.target.style.borderColor = '#16214a';
                }}
              >
