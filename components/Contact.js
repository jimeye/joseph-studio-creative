    ...
    <section id="contact" className="section-padding bg-official">
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-12 w-full max-w-none mx-0">
          {/* Formulaire */}
          <div className="bg-white rounded-lg p-8 border-2" style={{ borderColor: '#16214a', boxShadow: '4px 4px 0px #16214a' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent bg-white"
              ...
              <div className="mt-8">
                                        <button
                            type="submit"
                            className="text-lg flex items-center gap-2 bg-white font-bold py-3 px-8 rounded-lg border border-[#16214a] hover:transform hover:-translate-x-1 hover:-translate-y-1 transition-all duration-300 hover:bg-[#ffff00]"
