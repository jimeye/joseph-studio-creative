...
export default function BlondieParisProject() {
  return (
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-base md:text-lg lg:text-xl font-normal tracking-tight hero-title" style={{ wordSpacing: '-0.1em', letterSpacing: '-0.05em', color: '#16214a', lineHeight: '0.9' }}>
                Un site sur-mesure pour Blondie Paris
              </h1>
              <p className="text-base mt-2" style={{ color: '#16214a' }}>Bureau de relations presse & publiques</p>
            </div>
            <Link
              href="/"
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  "Relations presse françaises et internationales",
                  "Relations publiques",
                  "Production d'événements",
                  "Stratégie de communication sur-mesure",
                  "Accompagnement des marques",
                  "Réseau d'influenceurs clefs"
                ].map((feature, index) => (
                  ...
                  <div className="bg-[#f9f7f2] border-2 border-gray-300 h-80 flex flex-col overflow-hidden">
                    <div className="w-full h-full flex flex-col">
                      ...
                      <div className="w-full h-12 bg-[#f9f7f2] border-b border-gray-200 flex items-center justify-between px-6">
                        <div className="text-sm font-bold" style={{ color: '#16214a' }}>BLONDIE PARIS</div>
                        <div className="flex items-center space-x-6 text-xs">
                          <span style={{ color: '#16214a' }}>SERVICES</span>
                          <span style={{ color: '#16214a' }}>CLIENTS</span>
                          <span style={{ color: '#16214a' }}>ÉQUIPE</span>
                          <span style={{ color: '#16214a' }}>CONTACT</span>
                        </div>
                      </div>
                      {/* Hero Section */}
                      <div className="flex-1 relative">
                        <div className="w-full h-full bg-gradient-to-br from-pink-100 via-pink-50 to-white flex items-center justify-center relative">
                          {/* PR Elements */}
                          <div className="absolute top-4 left-4 w-16 h-16 bg-pink-200 rounded-full opacity-60"></div>
                          <div className="absolute top-8 right-8 w-12 h-12 bg-pink-300 rounded-full opacity-40"></div>
                          <div className="absolute bottom-8 left-8 w-20 h-20 bg-pink-100 rounded-full opacity-30"></div>
                          <div className="absolute bottom-4 right-4 w-14 h-14 bg-pink-200 rounded-full opacity-50"></div>
                          
                          {/* Text Overlay */}
                          <div className="absolute bottom-6 left-6 text-[#16214a] z-10">
                            <h2 className="text-2xl font-bold mb-2">Blondie Paris</h2>
                            <p className="text-sm opacity-90">Relations presse & publiques</p>
                            <p className="text-xs opacity-75">Communication sur-mesure</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-[#f9f7f2] border-2 border-gray-300 w-40 h-80 flex flex-col overflow-hidden rounded-2xl">
                      <div className="w-full h-full flex flex-col">
                        ...
                        <div className="w-full h-10 bg-[#f9f7f2] border-b border-gray-200 flex items-center justify-between px-3">
                          <div className="text-xs font-bold" style={{ color: '#16214a' }}>BLONDIE</div>
                        ...
                        <div className="flex-1 relative">
                          <div className="w-full h-full bg-gradient-to-br from-pink-50 to-white flex items-center justify-center relative">
                            ...
                            <div className="absolute bottom-4 right-4 w-8 h-8 bg-pink-300 rounded-full opacity-40"></div>
                            
                            {/* Text Center */}
                            <div className="absolute inset-0 flex items-center justify-center text-center">
                              <div>
                                <h3 className="text-sm font-bold mb-1 text-[#16214a]">Blondie Paris</h3>
                                <p className="text-xs opacity-90 text-[#16214a]">Relations Presse</p>
                                <p className="text-xs opacity-75 text-[#16214a]">Communication</p>
                              </div>
                            </div>
                          </div>
                        </div>
