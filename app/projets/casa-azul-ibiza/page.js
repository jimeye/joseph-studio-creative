...
export default function CasaAzulIbizaProject() {
  return (
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-base md:text-lg lg:text-xl font-normal tracking-tight hero-title" style={{ wordSpacing: '-0.1em', letterSpacing: '-0.05em', color: '#16214a', lineHeight: '0.9' }}>
                Un site sur-mesure pour Casa Azul Ibiza
              </h1>
              <p className="text-base mt-2" style={{ color: '#16214a' }}>Guest house de luxe & expériences uniques</p>
            </div>
            <Link
              href="/"
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed mb-6" style={{ color: '#16214a' }}>
                Casa Azul Ibiza est une guest house de luxe nichée dans les collines d'Ibiza, offrant une expérience unique entre authenticité locale et confort moderne. Cette ancienne maison de pêcheur rénovée avec goût propose 8 chambres d'exception, chacune avec sa terrasse privée et vue panoramique sur la Méditerranée.
              </p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: '#16214a' }}>
                Le site web a été conçu pour capturer l'esprit bohème-chic d'Ibiza, avec un système de réservation intégré permettant aux voyageurs de réserver leurs séjours en toute simplicité. L'expérience utilisateur met l'accent sur la découverte des chambres, des services premium et des activités exclusives proposées par la guest house.
              </p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: '#16214a' }}>
                Casa Azul Ibiza propose également des expériences uniques : cours de yoga au lever du soleil, dégustation de vins locaux, excursions en bateau privé et dîners gastronomiques préparés par le chef local.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Expériences et activités exclusives"
                ].map((feature, index) => (
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {["Next.js", "React", "TypeScript", "Stripe"].map((tech, index) => (
                  <span
                    key={index}
            ...
            <div className="pt-8">
              <a
                href="https://casa-azul-ibiza.vercel.app/"
                target="_blank"
                  ...
                  <div className="bg-[#f9f7f2] border-2 border-gray-300 h-80 flex flex-col overflow-hidden">
                    <div className="w-full h-full flex flex-col">
                      ...
                      <div className="w-full h-12 bg-[#f9f7f2] border-b border-gray-200 flex items-center justify-between px-6">
                        <div className="text-sm font-bold" style={{ color: '#16214a' }}>CASA AZUL IBIZA</div>
                        <div className="flex items-center space-x-6 text-xs">
                          <span style={{ color: '#16214a' }}>CHAMBRES</span>
                          <span style={{ color: '#16214a' }}>EXPÉRIENCES</span>
                      ...
                      <div className="flex-1 relative">
                        <div className="w-full h-full bg-gradient-to-br from-blue-50 via-cyan-50 to-white flex items-center justify-center relative">
                          {/* Mediterranean Elements */}
                          <div className="absolute top-4 left-4 w-16 h-16 bg-blue-200 rounded-full opacity-60"></div>
                          <div className="absolute top-8 right-8 w-12 h-12 bg-cyan-300 rounded-full opacity-40"></div>
                          <div className="absolute bottom-8 left-8 w-20 h-20 bg-blue-100 rounded-full opacity-30"></div>
                          <div className="absolute bottom-4 right-4 w-14 h-14 bg-cyan-200 rounded-full opacity-50"></div>
                          
                          {/* Text Overlay */}
                          <div className="absolute bottom-6 left-6 text-[#16214a] z-10">
                            <h2 className="text-2xl font-bold mb-2">Casa Azul</h2>
                            <p className="text-sm opacity-90">Guest house de luxe</p>
                            <p className="text-xs opacity-75">Ibiza, Méditerranée</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-[#f9f7f2] border-2 border-gray-300 w-40 h-80 flex flex-col overflow-hidden rounded-2xl">
                      <div className="w-full h-full flex flex-col">
                        ...
                        <div className="w-full h-10 bg-[#f9f7f2] border-b border-gray-200 flex items-center justify-between px-3">
                          <div className="text-xs font-bold" style={{ color: '#16214a' }}>CASA AZUL</div>
                        ...
                        {/* Content */}
                        <div className="flex-1 relative">
                          <div className="w-full h-full bg-gradient-to-br from-blue-50 to-white flex items-center justify-center relative">
                            {/* Mediterranean Elements */}
                            <div className="absolute top-4 left-4 w-10 h-10 bg-blue-200 rounded-full opacity-50"></div>
                            <div className="absolute bottom-4 right-4 w-8 h-8 bg-cyan-300 rounded-full opacity-40"></div>
                            
                            {/* Text Center */}
                            <div className="absolute inset-0 flex items-center justify-center text-center">
                              <div>
                                <h3 className="text-sm font-bold mb-1 text-[#16214a]">Casa Azul</h3>
                                <p className="text-xs opacity-90 text-[#16214a]">Guest House</p>
                                <p className="text-xs opacity-75 text-[#16214a]">Ibiza</p>
                              </div>
                            </div>
                          </div>
                        </div>
