...
export default function MelanieElbazProject() {
  return (
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-base md:text-lg lg:text-xl font-normal tracking-tight hero-title" style={{ wordSpacing: '-0.1em', letterSpacing: '-0.05em', color: '#16214a', lineHeight: '0.9' }}>
                Un site sur-mesure pour Mélanie Elbaz
              </h1>
              <p className="text-base mt-2" style={{ color: '#16214a' }}>Photographe française & artiste visuelle</p>
            </div>
            <Link
              href="/"
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed mb-6" style={{ color: '#16214a' }}>
                Mélanie Elbaz est une photographe française résidant à Paris, diplômée de l'École Nationale Supérieure de la Photographie d'Arles et de l'École Icart de Paris. Son univers visuel puise dans les codes de la street culture, de la mode, et des sonorités portées par Radio Nova.
              </p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: '#16214a' }}>
                Elle s'inspire du rap new-yorkais, afro-beat, garage britannique, bossa nova, acid jazz, entre autres. Mélanie a collaboré avec les plus grandes maisons de disques et vient de publier son premier livre maison rassemblant 70 photographies, chacune capturant l'essence d'un musicien.
              </p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: '#16214a' }}>
                Ses créations reflètent également son amour pour les voyages en Afrique et en Amérique latine, ainsi que sa fascination pour les savoir-faire artisanaux tels que les tissages, la broderie, et l'artisanat local.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  "Voyages Afrique & Amérique latine",
                  "Savoir-faire artisanaux",
                  "Collaborations disques",
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {["Squarespace", "Design System", "CMS", "Responsive"].map((tech, index) => (
                  <span
                    key={index}
            ...
            <div className="pt-8">
              <a
                href="https://www.melanieelbaz.com/"
                target="_blank"
                  ...
                  <div className="bg-[#f9f7f2] border-2 border-gray-300 h-80 flex flex-col overflow-hidden">
                    <div className="w-full h-full flex flex-col">
                      ...
                      <div className="w-full h-12 bg-[#f9f7f2] border-b border-gray-200 flex items-center justify-between px-6">
                        <div className="text-sm font-bold" style={{ color: '#16214a' }}>MÉLANIE ELBAZ</div>
                        <div className="flex items-center space-x-6 text-xs">
                          <span style={{ color: '#16214a' }}>WORK</span>
                          <span style={{ color: '#16214a' }}>BIO</span>
                          <span style={{ color: '#16214a' }}>VIDÉOS</span>
                      ...
                      <div className="flex-1 relative">
                        <div className="w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 flex items-center justify-center relative">
                          ...
                          <div className="absolute bottom-8 left-8 w-20 h-20 bg-red-500 rounded-full opacity-30"></div>
                          ...
                          <div className="absolute bottom-6 left-6 text-[#f9f7f2] z-10">
                            <h2 className="text-2xl font-bold mb-2">Mélanie Elbaz</h2>
                            <p className="text-sm opacity-90">Photographe</p>
                            <p className="text-xs opacity-75">Street culture & mode</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-[#f9f7f2] border-2 border-gray-300 w-40 h-80 flex flex-col overflow-hidden rounded-2xl">
                      <div className="w-full h-full flex flex-col">
                        ...
                        <div className="w-full h-10 bg-[#f9f7f2] border-b border-gray-200 flex items-center justify-between px-3">
                          <div className="text-xs font-bold" style={{ color: '#16214a' }}>MÉLANIE</div>
                        ...
                        <div className="flex-1 relative">
                          <div className="w-full h-full bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center relative">
                            {/* Photography Elements */}
                            <div className="absolute top-4 left-4 w-10 h-10 bg-yellow-400 rounded-full opacity-50"></div>
                            <div className="absolute bottom-4 right-4 w-8 h-8 bg-orange-400 rounded-full opacity-40"></div>
                            
                            {/* Text Center */}
                            <div className="absolute inset-0 flex items-center justify-center text-center">
                              <div>
                                <h3 className="text-sm font-bold mb-1 text-[#f9f7f2]">Mélanie Elbaz</h3>
                                <p className="text-xs opacity-90 text-[#f9f7f2]">Photographe</p>
                                <p className="text-xs opacity-75 text-[#f9f7f2]">Street Culture</p>
                              </div>
                            </div>
                          </div>
                        </div>
